(function() {
  ...
  const skillAliases = {
    ...
    'tolerancing': ['GD&T'],
    'kicad': ['KiCad'],
    'watch': ['watchOS', 'WatchConnectivity', 'HealthKit'],
    'apple watch': ['watchOS', 'WatchConnectivity', 'HealthKit'],
    'healthkit': ['HealthKit'],
    'wearable': ['HealthKit', 'Biosensors', 'BLE'],
    'widget': ['WidgetKit'],
    'claude': ['Claude API', 'Prompt Engineering', 'LLM Evals'],
    'prompt': ['Prompt Engineering', 'LLM Evals'],
    'eval': ['LLM Evals'],
    'evals': ['LLM Evals'],
    'product': ['Product Design', 'Product Roadmapping'],
    'pcb': ['KiCad', 'PCB Design'],
    'schematic': ['KiCad', 'PCB Design'],
    'dfm': ['DFM/DFA'],
    'manufacturing': ['DFM/DFA', 'CNC Machining', '3D Printing'],
    'odrive': ['ODrive'],
    'motor': ['BLDC Motors', 'ODrive', 'Stepper Motors', 'Servo Motors'],
    'motor control': ['BLDC Motors', 'ODrive', 'Motion Control', 'PID Control'],
    'motion control': ['Motion Control', 'BLDC Motors', 'PID Control'],
    'real time': ['Real-Time Control', 'Signal Processing'],
    'realtime': ['Real-Time Control', 'Signal Processing'],
    'telemetry': ['Telemetry', 'Data Logging'],
    'architecture': ['System Architecture'],
    'systems': ['System Architecture', 'Embedded Systems'],
    'spi': ['SPI'],
    'serial': ['SPI', 'I2C', 'UART'],
  ...
  const skillDomains = {
    ...
    'Real-Time Control': 'electrical',
    'Telemetry': 'electrical',
    'Bench Debug': 'electrical',
